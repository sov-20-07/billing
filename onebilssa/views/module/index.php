	...
	<div class="ltContainer ltFullWidth sizeChild">
		...
		<div class="ltRow">
			<div class="ltCell cell_page-content_control-panel">
				<a href="/<?=Funcs::$cdir?>/module/showadd/" class="button button_add-section">Добавить модуль</a>
			</div>
		</div>
							...
							<tr class="sections_table_row jsMoveElement" id="row<?=$item['id']?>">
								<td class="sections_table_cell">
									<div class="sections_table_row-header sections_table_row-header_catalog">
										<a class="sections_table_link" href="/<?=Funcs::$cdir?>/module/fieldlist/?module=<?=$item['id']?>"><?=$item['name']?></a>
									</div>
								</td>
								<td class="sections_table_cell">
									<?=$item['path']?>
								...
								<td class="sections_table_cell">
									<div class="sections_table_control-panel">
										<a href="/<?=Funcs::$cdir?>/module/showedit/?id=<?=$item['id']?>" class="icon icon_edit"></a>
										<a href="/<?=Funcs::$cdir?>/module/del/?id=<?=$item['id']?>" onclick="return confirm('Удалить модуль?')" class="icon icon_remove"></a>
									</div>
								</td>
								<td class="sections_table_cell">
									<div class="sections_table_move-panel">
										<input class="sections_input_order input_text" value="<?=$item['num']?>" onblur="if($(this).val()!=<?=$item['num']?>){defineSortNum(<?=$item['id']?>,'modules',$(this).val());}">
